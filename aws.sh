...
#export MAX_INSTANCE INSTANCE_TYPE REQUESTER CREATOR TICKET_ID SECURITY_CHECK
#PROJECT_ROOT="/var/lib/jenkins/topfan"
source ${HOME}/testkey
source ${PROJECT_ROOT}/varfile
TF_MODE=${1}

#export AWS_ACCESS_KEY_ID="${TOPFAN_ACCESS_KEY}"
#export AWS_SECRET_ACCESS_KEY="${TOPFAN_SECRET_KEY}"
# export TF_VAR_project="TopFan-Load-Injector"
# export TF_VAR_max_instance="${MAX_INSTANCE}"
# export TF_VAR_instance_type="${INSTANCE_TYPE}"
# export TF_VAR_requester="${REQUESTER}"
# export TF_VAR_creator="${CREATOR}"
# export TF_VAR_owner="TopFan"
# export TF_VAR_ticket_id="${TICKET_ID}"
